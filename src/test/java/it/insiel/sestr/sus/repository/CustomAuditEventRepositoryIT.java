package it.insiel.sestr.sus.repository;

import it.insiel.sestr.sus.ConfiguratoreInterfacceApp;

import it.insiel.sestr.sus.config.Constants;
import it.insiel.sestr.sus.config.audit.AuditEventConverter;
import it.insiel.sestr.sus.domain.PersistentAuditEvent;
...
import static it.insiel.sestr.sus.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
